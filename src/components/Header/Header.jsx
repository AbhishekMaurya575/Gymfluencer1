  ...
  return (
    <nav className='w-full  bg-none justify-center items-center flex h-[20vh] sm:[15vh] md:[20vh] absolute z-10  '>
      ...
      <div className='w-full sm:w-[142px]'>
        <img src='public\assets\asset 0.svg' className='w-[142px] h-[36px] text-xl' />
      </div>
      <div className='w-[50vw] '>
        <ul className='lg:flex hidden justify-around' style={{color:"#96979c"}} >
          <li>Home</li>
          <li>About</li>
          <li className='flex'>Our Services<img src='public\assets\asset 1.svg' className='w-[30px]'/></li>
          <li>Benefits</li> 
          <li>Blogs</li>
          <li>Contact</li>
        </ul>
